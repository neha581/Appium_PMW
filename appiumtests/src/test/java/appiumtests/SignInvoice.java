...
public class SignInvoice {
	...
	MobileElement invoice = (MobileElement) driver.findElementByAccessibilityId("confirm_invoice");
	Thread.sleep(12000);
	invoice.click();
	Thread.sleep(12000);
	System.out.println("invoice clicked");
	MobileElement accept = (MobileElement) driver.findElementByAccessibilityId("accept_invoice");
	Thread.sleep(12000);
	accept.click();
	Thread.sleep(12000);
	System.out.println("accept button clicked");
	MobileElement try_again = (MobileElement) driver.findElementByAccessibilityId("sign_1");
	Thread.sleep(12000);
	try_again.click();
	Thread.sleep(12000);
