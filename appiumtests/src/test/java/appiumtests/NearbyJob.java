...
public class NearbyJob {
	...
	public static void main(String[] args) {
		...
		Thread.sleep(25000);
		MobileElement New = (MobileElement) driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[2]/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup[1]");
		New.click();
		System.out.println("new tab clicked.");
		Thread.sleep(12000);
		MobileElement jobcard = (MobileElement) driver.findElementByAccessibilityId("jobcard_51");
		Thread.sleep(12000);
		jobcard.click();
		Thread.sleep(12000);
		...
		apply.click();
		Thread.sleep(12000);
		System.out.println("apply clicked, not able to apply. you can apply for this job only from few locations.");
		}
}
