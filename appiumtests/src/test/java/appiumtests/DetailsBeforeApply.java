...
public class DetailsBeforeApply {
	...
	System.out.println("your profile is incomplete");
	Thread.sleep(12000);
	MobileElement apply1 = (MobileElement) driver.findElementByAccessibilityId("apply_3");
	Thread.sleep(8000);
	apply1.click();
	Thread.sleep(2000);
	System.out.println("profile details filled.");
	MobileElement apply2 = (MobileElement) driver.findElementByAccessibilityId("apply_4");
	Thread.sleep(8000);
	apply2.click();
	Thread.sleep(2000);
