...
public class QuesOnApply2 {
	...
	MobileElement ans1 = (MobileElement) driver.findElementByAccessibilityId("text_1");
	ans1.sendKeys("ans");
	System.out.println("answer mandatory questions at task page which is added for previous stage.");
	Thread.sleep(2000);
	
	MobileElement submit2 = (MobileElement) driver.findElementByAccessibilityId("submit_quest");
	submit2.click();
	System.out.println("submit ans for mandatory questions and redirect to task page.");
	Thread.sleep(2000);
	}
