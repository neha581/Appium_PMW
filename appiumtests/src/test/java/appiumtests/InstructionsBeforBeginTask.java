...
public class InstructionsBeforBeginTask {
	...
	MobileElement carousel_next = (MobileElement) driver.findElementByAccessibilityId("carousel_next");
	Thread.sleep(12000);
	carousel_next.click();
	Thread.sleep(12000);
	System.out.println("instructions before starting task.");
	Thread.sleep(90000);
	MobileElement begin_task1 = (MobileElement) driver.findElementByAccessibilityId("begin_task");
	Thread.sleep(12000);
	begin_task1.click();
	Thread.sleep(12000);
	System.out.println("begin task clicked and redirect on task form.");
	}
}
